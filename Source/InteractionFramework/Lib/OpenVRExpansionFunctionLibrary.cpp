		...
		if (Result == EBPOVRResultSwitch::OnSucceeded)
		{
			...
			*/
			...
			else if (DeviceModelNumber.Find("vive", ESearchCase::IgnoreCase) != INDEX_NONE)
			{
				...
				else if (DeviceModelNumber.Find("Pico  Neo4", ESearchCase::IgnoreCase) != INDEX_NONE)
				{
					DeviceType = EBPOpenVRHMDDeviceType::DT_PicoNeo4;
				}
				else
				{
			...
			else if (DeviceModelNumber.Find("PSVR", ESearchCase::IgnoreCase) != INDEX_NONE)
			{
				DeviceType = EBPOpenVRHMDDeviceType::DT_PSVR;
			}
			else
			{
