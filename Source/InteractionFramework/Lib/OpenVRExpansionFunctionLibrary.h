...
struct INTERACTIONFRAMEWORK_API FBPOpenVRKeyboardHandle
{
	//GENERATED_BODY()
public:
...
struct INTERACTIONFRAMEWORK_API FBPOpenVRCameraHandle
{
	GENERATED_BODY()
public:
...
class INTERACTIONFRAMEWORK_API UOpenVRExpansionFunctionLibrary : public UBlueprintFunctionLibrary
{
	//GENERATED_BODY()
	GENERATED_BODY()
